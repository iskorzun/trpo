        ...
        <form class="login-form" role="form" method="POST" action="{{ url('/auth/login') }}">
            ...
            <div class="row">
                <div class="input-field col s4 center">
                    <a href="{!! url('/') !!}"><img id="login-logo" src="{!! asset('images/logo.png') !!}" alt=""
                                                    class="responsive-img valign profile-image-login"></a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12">
                    <button type="submit" class="btn waves-effect waves-light col s12">Войти</button>
                </div>
            </div>
